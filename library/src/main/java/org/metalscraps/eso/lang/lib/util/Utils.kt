...
class Utils {
    ...
    companion object {
        ...
        */ ////////////////////////////////////////////////////
        ...
        fun enCSVtoPOT() {
            val str = Files.readString(vars.baseDir.resolve("en.lang.csv"), AppConfig.CHARSET)
            val sb = StringBuilder("\"Location\",\"Source\",\"Target\"\n")
        ...
        */ ////////////////////////////////////////////////////
        ...
        private fun downloadPO(projectName: String, remainFiles:MutableList<String> = mutableListOf()) {
            ...
            fileNames.parallelStream().forEach {
                ...
                logger.info("downloaded zanata file  [$fileName] to local [$pPO] ${ltStart.until(ltEnd, ChronoUnit.SECONDS)}초")
            }
